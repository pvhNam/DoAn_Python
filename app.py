...
from models.database import init_db, close_db, get_db # Import get_db
from models.user import get_user_by_id
from utils.cafef import get_current_price # Hàm lấy giá của bạn
import time
...
def update_market_data_startup():
    ...
    with app.app_context():
        ...
        for symbol in symbols:
            try:
                # 1. Lấy giá hiện tại từ API
                price = get_current_price(symbol)
                if price == 0: price = 10000 # Fallback nếu lỗi
                
                # 2. TÍNH TOÁN CÁC CỘT CÒN THIẾU
                # Giả sử giá tham chiếu là giá làm tròn
                ...
                # 3. Lưu ĐỦ 5 cột quan trọng vào DB
                sql = """
